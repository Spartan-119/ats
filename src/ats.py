...
class ResumeParser:
    ...
    def __init__(self, resume_path, jd_path, skills_path):
        """
        Initializes the ResumeParser with paths to the resume, job description, and skills files.
...
# Example usage
parser = ResumeParser('resumes/resume_0.txt', 'job_descriptions/jd_2.txt', 'meta/skills.txt')
